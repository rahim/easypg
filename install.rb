# Insert line: [require "#{RAILS_ROOT}/vendor/plugins/easypg/lib/override_rake_task.rb"]
...
output= ""
inserted = false
line_to_insert = %q{require "#{RAILS_ROOT}/vendor/plugins/easypg/lib/override_rake_task.rb"}
